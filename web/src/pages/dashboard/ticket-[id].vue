...
<template>
                ...
                <div class="tw-flex tw-justify-between ">
                  ...
                  <div v-if="comment.liked_by" class="tw-flex tw-items-center tw-space-x-1 tw-space-y-1">
                    <div class="tw-flex tw-items-center tw-cursor-pointer">
                      ...
                      <div large @click="panelVisible = comment" class="tw-m-1">
  ...
  <aeria-panel v-model="panelVisible" float close-hint title="Curtido por:" @overlay-click="panelVisible = false">
    <div class="panel-content">
      <ul class="tw-list-none">
        <li>
          <div class="tw-flex tw-items-center" v-for="(user, index) in panelVisible.liked_by" :key="index">
